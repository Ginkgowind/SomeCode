...
#define TEST(catagory, name)                                                                         \
    static void _X_TEST_##catagory##_##name##_FUNC(void); /*是为了能够传入到xtest_register*/ \
    __attribute__((constructor)) static void _X_TEST_##catagory##_##name##_CONSTRUCT(void)           \
    {                                                                                                \
...
#define TEST(catagory, name)                                                \
    ...
    {                                                                       \
    public:                                                                 \
        _X_TEST_CLASS_##catagory##_##name(void)                             \
        {                                                                   \
            xtest_register(#catagory, #name, __FILE__, __LINE__,            \
                           NULL, _X_TEST_##catagory##_##name##_FUNC, NULL); \
        }                                                                   \
...
#define LOG_GREEN(format, args...)                   \
    do                                               \
    {                                                \
        printf("\033[32m" format "\033[0m", ##args); \
    } while (0)
...
#define EXPECT_STRCASEEQ(val1, val2)                         \
    do                                                       \
    {                                                        \
...
#define EXPECT_STRCASENE(val1, val2)                     \
    do                                                   \
    {                                                    \
        if (strcasecmp((val1), (val2)) == 0)             \
        {                                                \
...
#define EXPECT_FLOAT_EQ(value, expr)                    \
    do                                                  \
    {                                                   \
...
#define ASSERT_STRCASEEQ(val1, val2)                                     \
    do                                                                   \
    {                                                                    \
        if (strcasecmp((val1), (val2)) != 0)                             \
        {                                                                \
...
#define ASSERT_STRCASENE(val1, val2)                                 \
    do                                                               \
    {                                                                \
        if (strcasecmp((val1), (val2)) == 0)                         \
        {                                                            \
...
#define ASSERT_FLOAT_EQ(value, expr)                                \
    do                                                              \
    {                                                               \
        if (fabs((expr) - (value)) > EPSILON)                       \
        {                                                           \
